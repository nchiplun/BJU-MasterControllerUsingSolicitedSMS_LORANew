...
ifeq "$(wildcard nbproject/Makefile-local-18f66k40.mk)" "nbproject/Makefile-local-18f66k40.mk"
include nbproject/Makefile-local-18f66k40.mk
endif
endif
...
FINAL_IMAGE=${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ADC.c RTC_DS1307.c dataEncryption.c eeprom.c serailMonitor.c main_2_Test.c controllerActions_Test.c gsmTest.c loraTest.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/RTC_DS1307.p1 ${OBJECTDIR}/dataEncryption.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/serailMonitor.p1 ${OBJECTDIR}/main_2_Test.p1 ${OBJECTDIR}/controllerActions_Test.p1 ${OBJECTDIR}/gsmTest.p1 ${OBJECTDIR}/loraTest.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/RTC_DS1307.p1.d ${OBJECTDIR}/dataEncryption.p1.d ${OBJECTDIR}/eeprom.p1.d ${OBJECTDIR}/serailMonitor.p1.d ${OBJECTDIR}/main_2_Test.p1.d ${OBJECTDIR}/controllerActions_Test.p1.d ${OBJECTDIR}/gsmTest.p1.d ${OBJECTDIR}/loraTest.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/RTC_DS1307.p1 ${OBJECTDIR}/dataEncryption.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/serailMonitor.p1 ${OBJECTDIR}/main_2_Test.p1 ${OBJECTDIR}/controllerActions_Test.p1 ${OBJECTDIR}/gsmTest.p1 ${OBJECTDIR}/loraTest.p1

# Source Files
SOURCEFILES=ADC.c RTC_DS1307.c dataEncryption.c eeprom.c serailMonitor.c main_2_Test.c controllerActions_Test.c gsmTest.c loraTest.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-18f66k40.mk ${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
	@echo "User defined post-build step: [gnumkdir -p ${ProjectDir}\bin && cp ${ImagePath} ${ProjectDir}\bin\${PROJECTNAME}[${ConfName}].hex ]"
	@gnumkdir -p ${ProjectDir}\bin && cp ${ImagePath} ${ProjectDir}\bin\${PROJECTNAME}[${ConfName}].hex 
	@echo "--------------------------------------"
...
${OBJECTDIR}/ADC.p1: ADC.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/ADC.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_18f66k40=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/ADC.p1 ADC.c 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_18f66k40=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.map  -DXPRJ_18f66k40=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/BJU-MasterControllerUsingSolicitedSMS_LORANew.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
