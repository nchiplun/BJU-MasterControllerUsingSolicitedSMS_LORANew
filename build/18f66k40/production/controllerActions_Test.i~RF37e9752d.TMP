...
# 2 "<built-in>" 2
# 1 "controllerActions_Test.c" 2
# 11 "controllerActions_Test.c"
# 1 "./congfigBits.h" 1
# 16 "./congfigBits.h"
...
_Bool isBase64String(unsigned char * string) {
 ...
 while (*s++ != '\0') {
    ...
    return 1;
# 105 "controllerActions_Test.c"
}
# 115 "controllerActions_Test.c"
void setBCDdigit(unsigned char digit, _Bool dp_1) {
    PORTH = digit;
    PORTDbits.RD7 = dp_1;
}
# 129 "controllerActions_Test.c"
void getDateFromGSM(void) {
...
# 639 "controllerActions_Test.c"
        return 11;
    }
    else {
# 650 "controllerActions_Test.c"
        return 255;
    }

}
# 682 "controllerActions_Test.c"
...
# 1162 "controllerActions_Test.c"
}
# 1177 "controllerActions_Test.c"
_Bool isMotorInNoLoad(void) {
...
# 2004 "controllerActions_Test.c"
        if(moistureSensorFailed) {
            moistureSensorFailed = 0;

            sendSms(SmsMS1, userMobileNo, 2);
# 2016 "controllerActions_Test.c"
        }
        else {

            sendSms(SmsIrr4, userMobileNo, 2);
# 2028 "controllerActions_Test.c"
        }
    }
    else {
        valveDue = 0;
...
void deActivateValve(unsigned char FieldNo) {
    ...
    if (!LoraConnectionFailed && loraAttempt == 99) {
# 2124 "controllerActions_Test.c"
        sendSms(SmsIrr5, userMobileNo, 2);
# 2133 "controllerActions_Test.c"
    }
    else {

        sendSms(SmsIrr9, userMobileNo, 2);
# 2145 "controllerActions_Test.c"
    }
...
# 2956 "controllerActions_Test.c"
        }
        else {

            sendSms(SmsRTC4, userMobileNo, 0);
# 2968 "controllerActions_Test.c"
        }
    }
    ...
    if (valveDue && sleepCount == 0 && !dryRunDetected && !phaseFailureDetected && !onHold && !lowPhaseCurrentDetected) {
        for (field_No = 0; field_No < fieldCount; field_No++) {
            ...
            if (fieldValve[field_No].status == 1 && fieldValve[field_No].isFertigationEnabled && fieldValve[field_No].fertigationStage == 1) {
                ...
                injector1OffPeriod = 2;
                injector2OffPeriod = 1;
                injector3OffPeriod = 2;
...
# 3108 "controllerActions_Test.c"
                    break;
                }
                else {

                    sendSms(SmsFert6, userMobileNo, 2);
# 3122 "controllerActions_Test.c"
                    break;
                }
            }
